    ...
    <View style={styles.container}>
      <ScrollView bounces={false}>
        <View style={styles.userInfoSection}>
          ...
          <View style={{marginLeft: 20}}>
            <Title style={styles.title}>QWERTY</Title>
            <Caption style={styles.caption}>@qwerty07</Caption>
          </View>
         </View>
        </View>
      ...
      <View style={styles.userInfoSection}>
        <View style={styles.row}>
          ...
          <Text style={{color:'#777777', marginLeft: 20}}>Vijayawada, India</Text>
        </View>
        <View style={styles.row}>
        ...
        <View style={styles.row}>
          ...
          <Text style={{color:'#777777', marginLeft: 20}}>me20b2000@iiitdm.ac.in</Text>
        </View>
      </View>

      <View style={styles.editProfile}>
        <Button  mode="elevated" onPress={() => {}} style={{borderRadius: 10, borderStyle: 'dashed', borderColor: '#4682B4'}} rippleColor={'#4682B4'}>
      ...
      <View style={styles.infoBoxWrapper}>
        <View style={styles.infoBox}>
          <Title><FontAwesome name="rupee" size={18} color="black" />100</Title>
